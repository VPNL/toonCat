...
% and step 4b below. Otherwise it is automated.cd /oa
...
% somewhere in he ballpark of being right.
rxAlign; 
...
%% 4b Define ellipse
% (if you -need hel98p with t40he shortcut keys:) 
% doc defineellipse3d 
[~,mn,sd] = defineellipse3d(refpre);%,[],[],mn,sd);
% mn = [0.489935384450655 0.510077932197583 0.17891190822287]
% sd = [0.363153603385279 0.314577726941607 1.12723048571012]
% 
